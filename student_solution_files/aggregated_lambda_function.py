...
def lambda_handler(event, context):
    ...
    #    as the variable `db_response` >>> 
     # Instantiating a random value from 100 to 1,000,000,000.
    rid = random.randint(100, 1000000000) 
    # -----------------------------
    ...
    enquiry_text = dec_dict['message']    # Placing the website message into this variable
    ...
    critical_phrase_list = ['github', 'git', 'Git', 'GitHub', 'projects', 'portfolio', 'Portfolio', 'C.V', 'resume', 'Curriculum Vitae', 'Resume', 'CV']
    ...
    # --- Insert your code here ---
    # Do not change the name of this variable
    email_text = email_response(name, critical_phrase_list, phrase, sentiment)
